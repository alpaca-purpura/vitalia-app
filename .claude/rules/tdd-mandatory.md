...
Tests PRIMERO, implementación DESPUÉS. Sin excepciones. *(Materializada single-brand 2026-07-31.)*
...
- E2E (runner e2e del seam): ruta nueva → smoke en `vitalia/frontend/e2e/` ANTES página. Flow crítico modificado → regression.
...
Ver `.claude/rules/anti-default-flip-audit.md` (rule cardinal + inventario flags + enforcement layers).
