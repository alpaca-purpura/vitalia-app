...
- Enforce: arch-test `{brand}/frontend/src/__tests__/architecture/test-no-clerk-organizations.test.ts` (cada brand replica). Learning: `vitalia/docs/learnings/2026-06-01-fe-tenant-from-clerk-org-systemic.md`. MEMORY: `no-clerk-organizations`.
