...
> **Slim stub (context-rot pass 2026-05-30 · materializada 2026-07-31).** Cuerpo operativo completo en `.claude/skills/dev-team/references/test-design-doctrine.md` — carga on-demand cuando el skill `/dev-team` se activa. **Origen:** sesión 2026-05-28. **Cement-date:** 2026-05-28.
