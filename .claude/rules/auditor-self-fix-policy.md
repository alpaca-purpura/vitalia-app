...
¿Categoría STAKE-ASIMÉTRICO? (security/auth/tenant_id/PII/migration/prompt-slot/
 eval-goldens/state-machine/engine-core/meta-paradigm)
...
- ❌ Carril R en categoría stake-asimétrico (security/tenant/PII/migration/prompt/engine) — sigue siendo Carril C
