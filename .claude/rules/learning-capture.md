...
> **Slim stub (context-rot pass 2026-05-30 · materializada single-brand 2026-07-31).** Detalle completo en `docs/rules-detail/learning-capture.md` — load on-demand vía Read. **Origen:** conversación 2026-05-27 — cement-date 2026-05-27.
...
| Tipo | Path canónico |
|---|---|
| Técnico transversal (engine / repo-wide) | `docs/learnings/{date}-{slug}.md` |
| Negocio vitalia | `vitalia/docs/learnings/{date}-{slug}.md` |
...
- ❌ Learning técnico transversal capturado en `vitalia/docs/learnings/` cuando aplica al engine/repo entero
