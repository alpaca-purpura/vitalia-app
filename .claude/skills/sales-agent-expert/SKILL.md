...
- 2026-05-05 — R23 rule: agentic tickets `production_code=true` requieren el tier flagship (`models.flagship` del seam); `production_code=false` (tests/docs sobre agentic) → Sonnet OK. (`learnings.md R23`)
