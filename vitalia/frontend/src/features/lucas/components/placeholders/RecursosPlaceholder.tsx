...
/**
 * RecursosPlaceholder — EmptyState genérico para Lucas/Recursos.
...
/**
 * RecursosPlaceholder — placeholder genérico lucas/recursos.
 */
export function RecursosPlaceholder() {
  const meta = RIBBON_SUBTABS.lucas.find((s) => s.id === "recursos")!;
  return (
    <EmptyState
      icon={meta.icon}
