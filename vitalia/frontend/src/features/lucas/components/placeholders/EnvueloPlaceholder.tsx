...
/**
 * EnvueloPlaceholder — EmptyState genérico para Lucas/En vuelo.
...
/**
 * EnvueloPlaceholder — placeholder genérico lucas/envuelo.
 */
export function EnvueloPlaceholder() {
  const meta = RIBBON_SUBTABS.lucas.find((s) => s.id === "envuelo")!;
  return (
    <EmptyState
      icon={meta.icon}
