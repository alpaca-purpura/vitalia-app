...
/**
 * MultiplicarPlaceholder — placeholder genérico camila/multiplicar.
 */
export function MultiplicarPlaceholder() {
  const meta = RIBBON_SUBTABS.camila.find((s) => s.id === "multiplicar")!;
  return (
    <EmptyState
      icon={meta.icon}
