...
/**
 * DoctoresPlaceholder — EmptyState genérico para Lisa/Doctores.
...
/**
 * DoctoresPlaceholder — placeholder genérico lisa/doctores.
 */
export function DoctoresPlaceholder() {
  const meta = RIBBON_SUBTABS.lisa.find((s) => s.id === "doctores")!;
  return (
    <EmptyState
      icon={meta.icon}
