 ...
 *
 * Serves the LogoMark showcase fixture (6-cell grid) as a Next.js route.
 ...
 */
import LogoMarkShowcasePage from "@/../e2e/__test-pages__/topbar-global/logo-mark-showcase";

export default LogoMarkShowcasePage;
