...
# chris-input.md · vitalia-fase1-valeria-rail-history
...
Story cementada · este file es histórico read-only post-archive R2. Story migrada al schema v2: `release=F1`, `cap_target=valeria-sidebar`, `cap_change_type=new`. Legacy `outcome` + `phase` preservados.
