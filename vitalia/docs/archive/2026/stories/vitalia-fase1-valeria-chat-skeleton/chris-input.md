...
# chris-input.md · vitalia-fase1-valeria-chat-skeleton
...
Story cementada · este file es histórico read-only post-archive R2. Story migrada al schema v2: `release=F1`, `cap_target=valeria-chat`, `cap_change_type=new`. Legacy `outcome` + `phase` preservados.
