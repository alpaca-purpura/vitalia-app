...
# chris-input.md · vitalia-slice-1-inbox
...
Story cementada · este file es histórico read-only post-archive R2. Story migrada al schema v2: `release=F0`, `cap_target=inbox-tools-extensions`, `cap_change_type=new`. Legacy `outcome` + `phase` preservados.
