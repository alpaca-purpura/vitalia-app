...
# chris-input.md · vitalia-slice-1-onboarding-wizard
...
Story cementada · este file es histórico read-only post-archive R2. Story migrada al schema v2: `release=F0`, `cap_target=wizard-brand-studio-slice-1`, `cap_change_type=new`. Legacy `outcome` + `phase` preservados.
