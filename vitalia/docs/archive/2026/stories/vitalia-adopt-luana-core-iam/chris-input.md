...
# chris-input.md · vitalia-adopt-luana-core-iam
...
Story cementada · este file es histórico read-only post-archive R2. Story migrada al schema v2: `release=F0`, `cap_target=luana-core-adoption`, `cap_change_type=new`. Legacy `outcome` + `phase` preservados.
