...
# chris-input.md · vitalia-fase1-shell-layout-5050
...
Story cementada · este file es histórico read-only post-archive R2. Story migrada al schema v2: `release=F1`, `cap_target=layout-5050`, `cap_change_type=new`. Legacy `outcome` + `phase` preservados.
