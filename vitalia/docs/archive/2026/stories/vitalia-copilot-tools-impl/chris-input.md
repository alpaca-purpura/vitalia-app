...
# chris-input.md · vitalia-copilot-tools-impl
...
Story cementada · este file es histórico read-only post-archive R2. Story migrada al schema v2: `release=F0`, `cap_target=valeria-wizard-onboarding-agentic`, `cap_change_type=new`. Legacy `outcome` + `phase` preservados.
