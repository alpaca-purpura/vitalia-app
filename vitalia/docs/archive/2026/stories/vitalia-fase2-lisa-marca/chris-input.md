...
# chris-input.md · vitalia-fase2-lisa-marca
...
Story cementada · este file es histórico read-only post-archive R2. Story migrada al schema v2: `release=F2`, `cap_target=lisa-marca`, `cap_change_type=new`. Legacy `outcome` + `phase` preservados.
