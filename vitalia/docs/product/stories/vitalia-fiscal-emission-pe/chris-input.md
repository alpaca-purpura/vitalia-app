...
# chris-input.md · vitalia-fiscal-emission-pe
...
Cuando estés listo para refinar, llena 💭 Notas + 📎 Referencias arriba e invoca `/po-ux vitalia vitalia-fiscal-emission-pe` (o `/po` si es service story, o `/ux-agentico` si es agentic).
