...
# chris-input.md · vitalia-fase2-lucas-lanzar
...
Story migrada al schema v2: `release=F2`, `cap_target=lucas.lanzar`, `cap_change_type=new`. Legacy `outcome` + `phase` preservados durante deprecation gradual.

Cuando estés listo para refinar, llena 💭 Notas + 📎 Referencias arriba e invoca `/po-ux vitalia vitalia-fase2-lucas-lanzar` (o `/po` si es service story, o `/ux-agentico` si es agentic).
