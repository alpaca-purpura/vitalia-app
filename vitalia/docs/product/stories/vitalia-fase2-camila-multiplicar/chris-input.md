...
# chris-input.md · vitalia-fase2-camila-multiplicar
...
Story migrada al schema v2: `release=F2`, `cap_target=camila.multiplicar`, `cap_change_type=new`. Legacy `outcome` + `phase` preservados durante deprecation gradual.

Cuando estés listo para refinar, llena 💭 Notas + 📎 Referencias arriba e invoca `/po-ux vitalia vitalia-fase2-camila-multiplicar` (o `/po` si es service story, o `/ux-agentico` si es agentic).
