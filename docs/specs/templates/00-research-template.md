...
>
> **Owner:** Chris + `/pm-{sistema}` (o `/pm-{platform}` si es cross-sistema). NO `/po` (research es pre-spec, no spec).
>
...
- **H2:** Aprovechamos Y de {sistema} (multitenant + voice fidelity) ...
