---
doc_type: architecture-research            # SSoT vivo (NO una user-story — graduado 2026-06-02)
title: empleados-IA + auto-extensión — research SSoT
home: docs/architecture/luana-platform/
status: living                              # el paraguas continúa (outcome items 1c/2/3/4/5)
adr: ADR-013-empleados-ia-auto-extension
paradigm: PARADIGM.md (§5b)
roadmap: docs/product/outcomes/empleados-ia-auto-extension-platform.md
graduated_from: docs/archive/2026/stories/empleados-ia-auto-extension/00-research.md   # story archivada 2026-06-02
created: 2026-06-01
...
> **★ Graduación SSoT (2026-06-02).** Este research nació dentro de la story
> `empleados-ia-auto-extension`. Una **user-story no debe ser SSoT** (Chris) → al cerrar el
> deliverable durable-flows L1, la story se archivó y este research se graduó a SSoT vivo de
> arquitectura. Es el hogar canónico de la investigación empleados-IA; `ADR-013` apunta acá
> para "detalle/investigación". La copia inmutable original vive en la story archivada.

# Research — Luana como sistema operativo de empleados-IA con auto-extensión

> **SSoT vivo** del paradigma unificado. Bundlea la investigación (estado del arte 2026 + OSS), las decisiones cementadas en sesión 2026-05-31→06-01, el panorama completo, y 4 casos borde que estresan el modelo. Complementa (no reemplaza) `PARADIGM.md` + `ADR-010` + `ADR-013`.
