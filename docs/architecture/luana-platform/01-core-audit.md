...
> **UPDATE 2026-05-15:** El plan original mencionaba 4 marcas. **Catálogo final = 10 marcas** (ratificado por Chris 2026-05-15). Las 6 nuevas (SaaSora, InmoFlow, Retailly, Fixia, Guestly, FitFlow) no cambian la filosofía de partición — siguen el mismo patrón ENGINE+CONFIG / ENGINE+EXTENSION via Extension SDK.

10 brand apps consumirán Luana core:

| # | Brand | Vertical | Cliente objetivo | Estado | Repo path |
|---|---|---|---|---|---|
| 1 | **Nicolify** | Agencias + Servicios B2B | Agencias marketing, software boutique, consultoras | ✅ canónico (shipped) | `luana-platform/nicolify` |
| 2 | **Vitalia** | Salud + Bienestar | Clínicas médicas, dentales, estéticas | ✅ shipped (Story 11) | `luana-platform/vitalia` |
| 3 | **Comunify** | Creator Economy + Educación | Coaches, creadores contenido, infoproductores | ✅ shipped (Story 12) | `luana-platform/comunify` |
| 4 | **Lupulo Labs** | Gastronomía | Restaurantes, bares, cafeterías | 🟡 placeholder (Story 13) | `luana-platform/lupulo` |
| 5 | **SaaSora** | SaaS + Productos Digitales | Startups tech, micro-SaaS, software | ⏳ bootstrap pendiente | `luana-platform/saasora` |
| 6 | **InmoFlow** | Real Estate | Brokers, agencias inmobiliarias | ⏳ bootstrap pendiente | `luana-platform/inmoflow` |
| 7 | **Retailly** | E-commerce / D2C | Tiendas online, marcas físicas | ⏳ bootstrap pendiente | `luana-platform/retailly` |
| 8 | **Fixia** | Servicios Hogar + Oficios | Plomeros, electricistas, HVAC, contractors | ⏳ bootstrap pendiente | `luana-platform/fixia` |
| 9 | **Guestly** | Turismo + Hotelería | Hoteles boutique, rentas vacacionales, tours | ⏳ bootstrap pendiente | `luana-platform/guestly` |
| 10 | **FitFlow** | Fitness + Deporte | Gimnasios, estudios yoga, boxes | ⏳ bootstrap pendiente | `luana-platform/fitflow` |

Luana = `luana-platform/core/` (paquetes Python `luana-core-*` + NPM `@luana/*`). Publica packages versionados a GitHub Packages (private). Brands consumen via `pip install luana-core-*` y `npm install @luana/*`.

### Diferenciación core per brand (input para Extension SDK extensions)

| Brand | Diferenciación funcional (tools brand-extension probables) |
|---|---|
| Nicolify | CRM ciclo largo · portal cliente · gestión propuestas/contratos · tracking horas facturables |
| SaaSora | Onboarding automatizado · gestión subscripciones (Stripe) · dashboards (Churn, MRR) · changelogs |
| Vitalia | Reservas prepagadas · historial médico · HIPAA-lite privacidad · seguimiento post-tratamiento |
| Comunify | Escalera de valor (offer ladder) · bóveda autoridad · motor comunidades · embudos venta |
| Lupulo Labs | Reservas mesa · pedidos digitales · integración KDS · agentes IA cocina |
| InmoFlow | Integración portales · mapas interactivos · lead routing por zona · calculadoras financieras |
| Retailly | Catálogos dinámicos · cart recovery · integración logística · cross-selling checkout |
| Fixia | Gestión técnicos campo · cotización on-site · reseñas locales SEO automatizadas |
| Guestly | Motor reservas estacional · sync OTAs (Airbnb/Booking) · guest experience management |
| FitFlow | Facturación recurrente membresías · control aforo · calendario clases · waivers/exoneraciones |
