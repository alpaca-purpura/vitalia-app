...
# side-effect only.
from luana_core_campaigns import observability as _campaigns_observability  # noqa: F401
...
# eval_simulator spec — lifted in AISALESHT Story B; optional in luana-platform
# until the eval module is promoted to luana-core-sales-agent.
try:
    from luana_core_sales_agent.observability.eval_simulator import spec as _eval_simulator_observability  # noqa: F401
except ImportError:
    pass
