...
Lifted from AISALESHT src/shared/infrastructure/channels/base.py.
"""
...
class BaseChannel(ABC):
    ...
    async def send_rich_message(self, message: OutgoingMessage) -> dict[str, Any]:
        ...
        blocks gracefully. This is safe because OutgoingMessage invariant guarantees
        ``text`` is the flattened plain-text equivalent of ``blocks``.
