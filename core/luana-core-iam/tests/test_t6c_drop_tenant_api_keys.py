...
def _load_migration_module():
    ...
    luana-platform note: Alembic migrations live in AISALESHT until Story 10.
    These migration-loading tests are skipped in luana-platform context.
    """
    import pytest
    ...
    if not migration_path.exists():
        pytest.skip(f"Migration file {_MIGRATION_FILENAME} not present in luana-platform (Story 10 territory)")
