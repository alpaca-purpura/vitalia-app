"""Test conftest for luana-core-flows.

Sets up minimal environment variables required by the shared workspace
(mirrors luana-core-idempotency conftest pattern per 03-arch-be.md § 1).
"""
