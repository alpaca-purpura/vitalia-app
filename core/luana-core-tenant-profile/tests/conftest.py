"""Fixtures for tenant_profile module tests in luana-platform.

Lifted from AISALESHT backend/tests/modules/tenant_profile/conftest.py.
Adapted: added db infrastructure + env vars (standalone package context).
"""
...
def db_engine():
    # Register IAM models first (tenant_profiles FK → tenants)
    ...
    from luana_core_tenant_profile.infrastructure.models.tenant_profile_model import TenantProfileModel  # noqa: F401
