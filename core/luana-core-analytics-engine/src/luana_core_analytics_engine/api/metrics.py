...
try:
    from luana_core_connections.application.services.connection_port_impl import (  # type: ignore[import-not-found]
        ConnectionPortImpl,
    )
except ImportError:
...
try:
    ...
    OfferReadPortImpl = None  # type: ignore[assignment,misc]  # noqa: N816  # Story 5 deferred
...
@router.get("/{stage}/groups/{group_key}")
...
@router.post("/trigger-period-extraction")
