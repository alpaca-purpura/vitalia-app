...
try:
    import luana_core_platform.infrastructure.model_registry  # noqa: F401 — model registration (graceful if not all modules lifted yet)
except ImportError:
    pass  # model_registry has deferred src.modules.* — skip until all modules lifted
