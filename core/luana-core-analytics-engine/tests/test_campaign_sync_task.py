...
_connections_available = importlib.util.find_spec("luana_core_connections") is not None
_skip_if_no_connections = pytest.mark.skipif(
    not _connections_available,
    reason="luana_core_connections not yet installed (T-5 deferred)",
)
