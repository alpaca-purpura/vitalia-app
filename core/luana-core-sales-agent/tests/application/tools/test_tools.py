...
class TestCheckSchedule:
    ...
    def test_success_when_calendar_connected(self, _mock_cls):
        ...
        with patch(
            "luana_core_scheduling.application.services.availability_service.AvailabilityService",
...
class TestToolExecutor:
    ...
    def test_dispatches_to_correct_tool(self):
        ...
        import luana_core_sales_agent.application.agents.sales.nodes as nodes_mod
