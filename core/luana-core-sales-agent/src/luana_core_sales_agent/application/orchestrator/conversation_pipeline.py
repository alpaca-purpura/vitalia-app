...
class ConversationPipeline:
    ...
    def build_initial_state(
        *,
        ...
        checkpoint_data, last_session_summary = (
            ConversationPipeline.build_checkpoint_data(
                checkpoint,
    ...
    async def prepare_messages_and_intent(
        ...
        sanitized_text = await ConversationPipeline.sanitize_text(
            incoming.text, "user_input"
        )
