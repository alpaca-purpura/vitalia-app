...
class InternalSchedulerProvider:
    ...
    def get_available_slots(
        ...
        *,
        ...
        return [
            SchedulerSlot(start_time=start_time, duration_minutes=duration)
    ...
    def _derive_status(
        *,
        ...
        if appointment_status:
            ...
            if mapped == BookingStatusValue.CONFIRMED and appointment_start is not None:
                ...
                aware_start = (
                    ...
                    else appointment_start.replace(tzinfo=dt.UTC)
                )
        ...
        expires_aware = (
            link_expires_at
            if link_expires_at.tzinfo
            else link_expires_at.replace(tzinfo=dt.UTC)
        )
