...
BRAND_FIELD_OVERRIDES: dict[str, Override] = {
    ...
    "identity.brand_name": Override(
        label_es="Nombre",
        priority=100,
        is_required_semantic=True,
        human_question_es="¿Cuál es el nombre de tu marca?",
        expects="una palabra o frase corta (1-4 palabras)",
    ),
    "identity.tagline": Override(
        label_es="Tagline",
        priority=85,
        is_required_semantic=True,
        gate="identity.brand_name",
        human_question_es="¿Tienes un tagline o frase que acompañe tu marca?",
        expects="una frase corta (5-10 palabras)",
    ),
    "identity.description": Override(
        label_es="Descripción",
        priority=80,
        is_required_semantic=True,
        gate="identity.brand_name",
        human_question_es="Describe tu marca en una o dos oraciones.",
        expects="2-3 oraciones",
    ),
    "identity.industry": Override(
        label_es="Industria",
        priority=75,
        is_required_semantic=True,
        human_question_es="¿En qué industria o sector opera tu marca?",
        expects="palabra/frase corta (educación, salud, fitness, software, etc.)",
    ),
    "identity.website": Override(
        label_es="Sitio web",
        priority=70,
        human_question_es="¿Cuál es la URL de tu sitio web principal?",
        expects="URL completa (https://…)",
    ),
    ...
    "story.origin_story": Override(
        label_es="Historia de origen",
        priority=70,
        is_required_semantic=True,
        human_question_es="¿Cómo nació tu marca? Cuenta la historia de origen.",
        expects="2-4 oraciones",
    ),
    "story.mission": Override(
        label_es="Misión",
        priority=80,
        is_required_semantic=True,
        human_question_es="¿Cuál es la misión de tu marca?",
        expects="1-2 oraciones",
    ),
    "story.vision": Override(
        label_es="Visión",
        priority=75,
        is_required_semantic=True,
        human_question_es="¿Cuál es la visión a largo plazo de tu marca?",
        expects="1-2 oraciones",
    ),
    "contact.support_email": Override(
        label_es="Email de soporte",
        priority=85,
        is_required_semantic=True,
        human_question_es="¿Cuál es el email de soporte que verán tus clientes?",
        expects="dirección de email válida",
    ),
    ...
    "visuals.primary_color": Override(
        label_es="Color primario",
        priority=70,
        is_required_semantic=True,
        human_question_es="¿Cuál es el color primario de tu marca?",
        expects="código hex (#RRGGBB)",
    ),
    ...
    "positioning.unique_value_proposition": Override(
        label_es="Propuesta de valor única (UVP)",
        priority=95,
        is_required_semantic=True,
        human_question_es="¿Cuál es tu propuesta de valor única (UVP)? ¿Qué te diferencia de la competencia?",
        expects="1-2 oraciones específicas",
    ),
    "narrative.one_liner": Override(label_es="One-liner"),
    "brand_personality.archetype": Override(
        label_es="Arquetipo",
        priority=85,
        is_required_semantic=True,
        human_question_es="¿Qué arquetipo describe mejor tu marca? (ej. el sabio, el héroe, el creador)",
        expects="uno de los 12 arquetipos clásicos de Jung",
    ),
    "brand_personality.core_values": Override(
        label_es="Valores centrales",
        priority=70,
        human_question_es="¿Cuáles son los valores centrales de tu marca?",
        expects="lista de 3-5 valores",
    ),
    "brand_personality.personality_traits": Override(
        label_es="Rasgos de personalidad",
        priority=65,
        human_question_es="¿Qué rasgos de personalidad expresa tu marca?",
        expects="3-5 adjetivos",
    ),
}
