...
class TestValidateFieldPath:
    ...
    def test_buyer_persona_all_guided_block_paths(self) -> None:
        """Every field_path generated by the guided block generator must be valid."""
        from luana_core_copilot.application.guided.block_generator import build_blocks

        for block in build_blocks("buyer_persona"):
            for path in block.field_paths:
