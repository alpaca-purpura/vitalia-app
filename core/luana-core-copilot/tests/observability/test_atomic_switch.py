...
class TestChatHotPathImportsNewModule:
    ...
    def test_does_not_import_legacy_modules(self) -> None:
        text = CHAT_PY.read_text()
        legacy_imports = [
            "from luana_core_copilot.application.observability.trace_recorder",
            "from luana_core_copilot.application.observability.node_trace",
            "from luana_core_copilot.application.orchestrator.usage_tracking",
            "from luana_core_copilot.application.observability import trace_recorder",
        ]
