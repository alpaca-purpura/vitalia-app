...
_FORMATS: tuple[FormatMetadata, ...] = (
    ...
    FormatMetadata(
        ...
        suitable_for={
            ExpertBusinessType.ACADEMIA_INFOPRODUCTOR: 1.0,
            ExpertBusinessType.CONSULTOR_PROFESIONAL: 1.0,
            ExpertBusinessType.COACH_MENTOR: 1.0,
            ExpertBusinessType.PROFESIONAL_SALUD: 1.0,
            ExpertBusinessType.AGENCIA_FREELANCE: 0.5,
            ExpertBusinessType.ANFITRION_PRODUCTOR: 0.5,
            ExpertBusinessType.SOFTWARE_SAAS: 0.5,
        },
    ...
    FormatMetadata(
        ...
        suitable_for={
            ExpertBusinessType.ACADEMIA_INFOPRODUCTOR: 1.0,
            ExpertBusinessType.COACH_MENTOR: 1.0,
            ExpertBusinessType.PROFESIONAL_SALUD: 0.5,
            ExpertBusinessType.CONSULTOR_PROFESIONAL: 0.5,
            ExpertBusinessType.SOFTWARE_SAAS: 0.5,
        },
    ...
    FormatMetadata(
        ...
        suitable_for={
            ExpertBusinessType.ACADEMIA_INFOPRODUCTOR: 1.0,
            ExpertBusinessType.CONSULTOR_PROFESIONAL: 1.0,
            ExpertBusinessType.AGENCIA_FREELANCE: 1.0,
            ExpertBusinessType.SOFTWARE_SAAS: 0.5,
    ...
    FormatMetadata(
        ...
        delivery_model=OfferDeliveryModel.DIY,
        suitable_for={
            ExpertBusinessType.MARCA_ECOMMERCE: 1.0,
            ExpertBusinessType.NEGOCIO_LOCAL: 0.5,
            ExpertBusinessType.ANFITRION_PRODUCTOR: 0.5,
        },
    ...
    FormatMetadata(
        ...
        suitable_for={
            ...
            ExpertBusinessType.CONSULTOR_PROFESIONAL: 1.0,
            ExpertBusinessType.PROFESIONAL_SALUD: 1.0,
            ExpertBusinessType.ACADEMIA_INFOPRODUCTOR: 0.5,
        },
    ...
    FormatMetadata(
        ...
        suitable_for={
            ...
            ExpertBusinessType.CONSULTOR_PROFESIONAL: 1.0,
            ExpertBusinessType.PROFESIONAL_SALUD: 1.0,
            ExpertBusinessType.NEGOCIO_LOCAL: 1.0,
            ExpertBusinessType.SOFTWARE_SAAS: 0.5,
        },
    ...
    FormatMetadata(
        ...
        delivery_model=OfferDeliveryModel.DIY,
        suitable_for={
            ExpertBusinessType.ANFITRION_PRODUCTOR: 1.0,
            ExpertBusinessType.ACADEMIA_INFOPRODUCTOR: 1.0,
            ExpertBusinessType.COACH_MENTOR: 1.0,
            ExpertBusinessType.NEGOCIO_LOCAL: 1.0,
            ExpertBusinessType.CONSULTOR_PROFESIONAL: 0.5,
    ...
    FormatMetadata(
        ...
        suitable_for={
            ExpertBusinessType.ANFITRION_PRODUCTOR: 1.0,
            ExpertBusinessType.ACADEMIA_INFOPRODUCTOR: 1.0,
            ExpertBusinessType.MARCA_ECOMMERCE: 0.5,
            ExpertBusinessType.NEGOCIO_LOCAL: 0.5,
        },
