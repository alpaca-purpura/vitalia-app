"""Architecture fitness: Story 4 engines are brand-agnostic.

Per 03-arch.md §7.3. Story 4 packages (crm, analytics-engine, landing, connections)
MUST NOT contain brand-specific conditionals or hardcoded brand identifiers.
...
V-AG-3 validator (Story 4 extension of V-AG-1).
"""
...
def test_no_hardcoded_clerk_app_ids():
    """No hardcoded Clerk app IDs in Story 4 source files.
