...
from luana_core_connections.api.dependencies.webhook_security import (  # noqa: E402
...
# ---------------------------------------------------------------------------
# copilot_provider/provider.py — DEFERRED to Story 6
# ---------------------------------------------------------------------------

try:
    from luana_core_connections.copilot_provider.provider import (  # type: ignore[import-not-found]
        ConnectionsCopilotProvider,
        _connections_read_fn,
        _connections_repo_factory,
    )

    _COPILOT_PROVIDER_AVAILABLE = True
except ImportError:
    _COPILOT_PROVIDER_AVAILABLE = False


@pytest.mark.skipif(
    not _COPILOT_PROVIDER_AVAILABLE,
    reason="copilot_provider deferred to Story 6",
)
...
from luana_core_connections.infrastructure.channels.webhook import WebhookAdapter  # noqa: E402
from luana_core_platform.domain.messages import OutgoingMessage  # noqa: E402
